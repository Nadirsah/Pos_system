                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="{{asset($data->image)}}"
                                                alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled pb-3">
                            <li>
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text"><strong>{{$data->brand}}</strong></p>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text"><strong>{{$data->color}}</strong></p>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text"><strong>{{$data->price}} azn</strong></p>
                                    </li>
                                </ul>
                            ...
                            <li>
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text"><strong>{{$data->content}}</strong></p>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="row pb-3">
                            <div class="col d-grid">
                                <a href="#" class="btn btn-success btn-lg" name="submit" value="buy"><i
                                        class="fa-brands fa-whatsapp me-3"></i>Sifariş et</a>
                            </div>
