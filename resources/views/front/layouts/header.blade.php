...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset($header->image)}}">
    ...
    <!-- Slick -->
    <link href="{{asset('front/')}}/assets/swiper/swiper-bundle.min.css" rel="stylesheet">
